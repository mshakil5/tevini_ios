...
class MoneyInScreen extends GetWidget<MoneyInController> {
  const MoneyInScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: CustomAppBar(
            ...
            centerTitle: true,
            title: AppbarTitle(text: "msg_view_transactions".tr)),
        body: Container(
