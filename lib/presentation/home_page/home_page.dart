          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                controller.isTDF.value == true ? transferToTDF() : Container(),

                ///----------- End -----------------
                SizedBox(height: 5.v),
                if (controller.donationRequests > 0)
                InkWell(
                  onTap: () {
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                                'You have ${controller.donationRequests} donation request${controller.donationRequests > 1 ? 's' : ''}.',
                                style: TextStyle(
                                    color: Colors.white,
                                    fontWeight: FontWeight.bold)),
                            InkWell(
                                onTap: () {
                                  controller.removeAllDonationRequest();
                                },
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                            ' £ ' +
                                controller.getUserInfo.value.expected_gift_aid
                                    .toString(),
                            style: theme.textTheme.titleMedium,
                          ),
                        ],
                    ...
                    child: Column(
                        ...
                        children: [
                              ...
                              child: Container(
                                  ...
                                  child: Stack(
                                      ...
                                      children: [
                                        ...
                                        Obx(
                                          () => AnimatedOpacity(
                                              opacity: controller.isBalanceShown
                                                          .value ==
                                                      false
                                                  ? 0
                                                  : 1,
                                              ...
                                              duration: const Duration(
                                                  milliseconds: 500),
                                              child: Text(
                                                  '${'${controller.currentBalance.value ?? ''} GBP' /*balance.toString()*/} ',
                                                  style: TextStyle(
                                                      color: Colors.teal,
                                                      fontSize: 11))),
                                        ),
                          ...
                          Padding(
                            ...
                            child: Text(
                              "Pending Balance:  " +
                                  "${double.parse(controller.pendingTransaction.value).toStringAsFixed(2)}" +
                                  " GBP",
                              style:
                    ...
                    child: Container(
                        ...
                        child: Column(
                            ...
                            children: [
                              ...
                              CustomTextFormField(
                                  controller:
                                      controller.tdfAccToTransferController,
